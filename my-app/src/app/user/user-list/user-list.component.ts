...
export class UserListComponent implements OnInit {
  ...
  constructor(
    ...
    this.displayedColumns = ['id', 'name', 'api_token', 'active', 'level_id', 'created', 'updated', 'actions'];
  }
  ngOnInit() {
    this.loadingList();
  }
  ...
  loadingList() {
    ...
    // OBSERVABLE
    this.UsuarioService.getItems().subscribe(
      // CORRECT
      (response) => {
        this.cargando = false;
        /* tslint:disable:no-string-literal */
        this.UsuarioService.setItems(response['data']);
  ...
  refresh() {
    // this.dataSource = new MatTableDataSource<UsuarioInterface>(this.dataSource.data);
