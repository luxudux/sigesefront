...
import { FinalizadoService } from '../../../services/documento/finalizado/finalizado.service';
// MOMENT
...
@Component({
  selector: 'app-document-list-finished',
  templateUrl: './document-list-finished.component.html',
  styleUrls: ['./document-list-finished.component.css'],
  animations: [
...
export class DocumentListFinishedComponent implements OnInit {
  ...
  expandedElement: DocumentoInterface | null;
  ...
  constructor(
    ...
    public FinalizadoService: FinalizadoService,
  ...
  loadingList() {
    ...
    // OBSERVABLE
    this.FinalizadoService.getItems().subscribe(
      // CORRECT
      (response) => {
        this.cargando = false;
        /* tslint:disable:no-string-literal */
        this.FinalizadoService.setItems(response['data']);
